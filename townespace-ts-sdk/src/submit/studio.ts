...
import { getPropertyValueRaw, getSinglePropertyValueRaw } from "aptos/src/utils/property_map_serde";
import { 
    Account, 
    AnyNumber, 
...
// Setup the client
const APTOS_NETWORK: Network = process.env.APTOS_NETWORK ? NetworkToNetworkName[process.env.APTOS_NETWORK] || Network.TESTNET : Network.TESTNET;
