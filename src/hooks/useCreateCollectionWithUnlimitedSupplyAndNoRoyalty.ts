import { COMPOSABLE_TOKEN_TESTNET, CREATE_COLLECTION_WITH_UNLIMITED_SUPPLY_AND_NO_ROYALTY, STUDIO } from "../constants";
...
const useCreateCollectionWithUnlimitedSupplyAndNoRoyalty = (
    ...
    const payload = async () => {
        const response = await signAndSubmitTransaction({
            ...
            data: { 
                function: `${COMPOSABLE_TOKEN_TESTNET}::${STUDIO}::${CREATE_COLLECTION_WITH_UNLIMITED_SUPPLY_AND_NO_ROYALTY}`,
                typeArguments: [],
                functionArguments: [ 
                    description,
                    name,
