...
const CollectionPanel = () => {
   ...
   const [currentCollection, setCurrentCollection] = useState<NftMetadataType | null>(null);
   const dispatch = useAppDispatch();

   const { loading, error, data } = useQuery(NFT_COLLECTION_OWNED_QUERY, {
      variables: { wallet: "0x239589c5cfb0cc96f76fa59165a7cbb6ef99ad50d0acc34cf3a2585d861511be", offset: 0 },
   });
