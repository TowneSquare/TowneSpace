...
const RemovePanel = () => {
   ...
   return (
      <div className={`${isOpen ? "flex" : "hidden"} absolute inset-0 h-[100vh] bg-[#00000050] justify-center items-center`}>
         <div className="p-4 w-1/3 bg-gray-dark-2 rounded-md border border-gray-light-3">
            <div className="flex justify-between">
               ...
               <div className="w-4 h-4 cursor-pointer" onClick={() => dispatch(toggleRemovePanel(false))}>
                  <p className="text-xl font-semibold">×</p>
               </div>
            </div>
            <div className="w-full flex justify-center mt-8">
               <div className="w-[180px] h-[180px] bg-gray-dark-1 rounded-md">
                  <img src={currentTrait?.uri} alt="uri" className="w-[180px] h-[180px]" />
               </div>
            </div>
            <p className="text-lg text-center mt-8">
               Do you want to remove {currentTrait?.name} from {currentNft?.name}? <br />
