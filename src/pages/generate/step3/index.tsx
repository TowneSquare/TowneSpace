...
const Options = [
   {
      ...
      content: "Deploy to Testnet in order to test if the assets upload successfully and that there are no critical errors. You will need Testnet APT to pay the gas fees ",
   },
   {
      title: "Aptos Mainnet",
      content: "Deploy to Mainnet and your collection will be live on the Aptos blockchain. Please keep in mind that further modifications to the smart contract won’t be possible",
   }
]