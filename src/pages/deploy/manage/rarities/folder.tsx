                  ...
                  <div className="flex flex-col md:flex-row gap-2 md:gap-10">
                     <div className="flex gap-2 md:gap-10">
                        <div className="flex gap-2 md:gap-4 items-center">
                           ...
                           <p className="text-sm md:text-base w-16 md:w-20">{file.name}</p>
                        </div>
                        <div className="flex items-center gap-4 md:gap-10">
                           <Slider className="md:w-[250px]" value={file.rarities} onChange={(value) => onChangeRarities(value, index)} />
                     ...
                     <div className="flex items-center gap-10">
                        ...
                        <p className="text-sm md:text-base">{Math.floor(traits.length * file.rarities / 100)}</p>
                     </div>
                  </div>
               </div>
            ))}
