...
const TokenPreview = () => {
  ...
  return (
    <>
      {currentToken && (
        <div>
          <div className="min-w-[260px] md:min-w-[315px] items-center   bg-gray-dark-2 rounded-t-md">
            <div className=" pr-2 flex justify-end">
              <div className="w-6 cursor-pointer" onClick={() => onClose()}>
                <p className="text-4xl ">×</p>
              </div>
            </div>
            <div className=" flex items-center justify-center px-8  items-center">
              <div>
                <div className="">
                  <canvas
                    ref={canvasRef}
                        ...
                        <div className="p-[8px] w-full rounded-md bg-gray-dark-1/10">
                          ...
                          >
                            ...
                            <div className="flex flex-col justify-start text-left">
                              <p className="text-xs uppercase text-gray-light-1">
                                {file.folderName}
                              </p>
            ...
            <div className="p-6 border-t-2 bg-gray-dark-2 rounded-b-md border-gray-light-3">
              <SecondaryButton type={ButtonStatus.active} className="w-full">
                Regenerate
              </SecondaryButton>
            </div>
          </div>
