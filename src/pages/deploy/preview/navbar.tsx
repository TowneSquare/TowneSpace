      ...
      <div className="mt-8 px-4 flex items-end gap-4">
         ...
         <div className="">
            ...
            <div className="min-w-[130px] h-11 px-4 flex items-center border border-white rounded-full mt-1">
               <input className="w-full placeholder-gray-light-3 focus-visible:outline-0" placeholder="10,000"
         ...
         <div className="w-full h-11 px-4 py-2 flex gap-2 border border-white rounded-full">
            ...
            <input className="w-full placeholder-gray-light-3 focus-visible:outline-0" placeholder="Filter by name, trait"
               style={{ background: "none" }} />
         </div>
         <div className="">
            <p>Token Name</p>
            <div className="min-w-[48px] h-11 px-4 py-2 border border-white rounded-full mt-1">
               <input className="w-full placeholder-gray-light-3 focus-visible:outline-0" placeholder="Slothian"
                  style={{ background: "none" }} />
            </div>
         </div>
      </div>
